...
class CarrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create carro" do
    assert_difference("Carro.count") do
      post carros_url, params: { carro: { chassi: @carro.chassi, placa: @carro.placa, renavan: @carro.renavan } }
    end
  ...
  test "should update carro" do
    patch carro_url(@carro), params: { carro: { chassi: @carro.chassi, placa: @carro.placa, renavan: @carro.renavan } }
